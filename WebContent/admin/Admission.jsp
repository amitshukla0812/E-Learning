...
<!-- Online registration -->
    ...
    <form action="AdmissionInsert.jsp" method="post">
        ...
        <div class="row">
            <div class="mb-3 col-6">
                ...
                <select class="form-select form-control" name="course" id="course" required="required" >
        ...
        <div class="mb-3 col-6">
            ...
            <select class="form-select form-control" name="state" id="state" required="required">
            ...
            <input type="country" name="country" placeholder="country" id="country" 
                   required="country" class="form-control">
        </div>
        </div>
        <!-- Address -->
        <div class="mb-3">
